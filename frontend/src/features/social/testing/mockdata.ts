import type { CircleItem, SocialUserItem } from "../types";
...
const RAW_FOLLOWING_DATA: Omit<SocialUserItem, 'badgeImage'>[] = [
  { userId: 101, nickname: 'User_Alpha', bio: '그림 그리는 알파입니다.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 102, nickname: 'User_Beta', bio: 'Frontend Developer | React Love', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'MASTER' },
  ...
  { userId: 105, nickname: 'User_Delta', bio: '새로운 스타일 도전 중!', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', profileIcon: 'char_sad', level: 'ARTIST' },
  { userId: 106, nickname: 'User_Epsilon', bio: '매일매일 드로잉', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'MASTER' },
  ...
  { userId: 108, nickname: 'User_Eta', bio: 'Testing for UI components', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', profileIcon: 'char_sad', level: 'PAINTER' },
  { userId: 109, nickname: 'User_Theta', bio: '디지털 아트의 세계', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'ARTIST' },
  { userId: 112, nickname: 'User_Iota', bio: '반가워요!', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 111, nickname: 'User_Kappa', bio: '일러스트레이터 지망생', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'PAINTER' },
  { userId: 113, nickname: 'Sketch_Lover', bio: '연필 크로키 위주로 올려요.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 114, nickname: 'Art_Monitor', bio: '전시회 정보 공유', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'MASTER' },
  { userId: 115, nickname: 'Pixel_King', bio: '도트 그래픽 장인입니다.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'ARTIST' },
  { userId: 116, nickname: 'Color_Full', bio: '수채화 느낌이 좋아요.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'PAINTER' },
  { userId: 117, nickname: 'Design_Tester', bio: 'UI/UX 디자인 공부 중', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 118, nickname: 'Blue_Sky', bio: '풍경화를 주로 그립니다.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'ARTIST' },
  { userId: 119, nickname: 'Red_Apple', bio: '정물화 연습생', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'PAINTER' },
  { userId: 120, nickname: 'Char_Designer', bio: '캐릭터 시트 작업 중', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'MASTER' },
  { userId: 121, nickname: 'Doodle_Doo', bio: '낙서장입니다.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 122, nickname: 'Line_Art', bio: '깔끔한 선화가 최고', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'PAINTER' },
  { userId: 123, nickname: 'Fantasy_World', bio: '판타지 배경 일러스트', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'ARTIST' },
  { userId: 124, nickname: 'Oil_Master', bio: '유화의 질감을 사랑합니다.', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'MASTER' },
  { userId: 125, nickname: 'Night_View', bio: '야경 전문 그림러', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'ARTIST' },
  { userId: 126, nickname: 'Daily_Sketch', bio: '365일 챌린지 중', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER' },
  { userId: 127, nickname: 'GDS_Fan', bio: 'GDS 최고!', isFollowing: true, profileImgUrl: '', followState: 'COMPLETED', level: 'PAINTER' },
];
...
const RAW_FOLLOWER_DATA: Omit<SocialUserItem, 'badgeImage'>[] = [
  { userId: 201, nickname: 'Sketcher_King', bio: 'Art is my life', isFollowing: false, profileImgUrl: '', followState: 'COMPLETED', level: 'SKETCHER', profileIcon: 'char_sad' },

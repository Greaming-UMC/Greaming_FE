...
export const getFollowers = async (userId: number, params: CheckFollowersParamas) => {
  const response = await http.get<ApiDataSuccessResponse<CheckFollowersData>>(
...
export const getFollowings = async (userId: number, params: CheckFollowingsParams) => {
  const response = await http.get<ApiDataSuccessResponse<CheckFollowingsData>>(
...
export const followUser = async (targetId: number) => {
  const response = await http.post<ApiDataSuccessResponse<FollowRequestResult>>(
...
export const unfollowUser = async (targetId: number) => {
  const response = await http.delete<ApiDataSuccessResponse<null>>(
...
export const acceptFollowRequest = async () => {
  const response = await http.post<ApiDataSuccessResponse<RejectionAcceptData>>(
...
export const getCircleMembers = async (circleId: number) => {
  const response = await http.get<ApiResultResponse<CheckCircleMembersResult>>(
...
export const getCircles = async (params: ExploreCircleRequest) => {
  const response = await http.get<ApiResultResponse<ExploreCircleResult>>(
...
export const kickCircleMember = async (circleId: number, memberId: number) => {
  const response = await http.delete<ApiResultResponse<kickCircleMembersResult>>(
...
export const createCircle = async (data: newCreatCircleRequest) => {
  const response = await http.post<ApiResultResponse<newCreatCircleResult>>(
...
export const getCircleProfile = async (circleId: number) => {
  const response = await http.get<ApiResultResponse<CheckCircleProfileResult>>(
...
export const updateCircleSettings = async (circleId: number, data: editCircleSettingsRequest) => {
  const response = await http.put<ApiResultResponse<editCircleSettingsResult>>(
...
export const searchUsersForInvite = async (circleId: number, params: ExploreUsersRequest) => {
  const response = await http.get<ApiResultResponse<ExploreUsersResult>>(

...
const variantStyles: Record<BadgeVariant, string> = {
  // [Tag] 
  tag: 'bg-surface-variant-lowest text-on-surface-variant-bright cursor-pointer border border-transparent rounded-[28px]',
  ...
  // [Outline]
  outline: 'bg-surface border border-[1px] border-solid border-outline text-on-surface-variant rounded-[12px]',
};

const sizeStyles: Record<BadgeSize, string> = {
  sm: 'h-6 px-2 text-xs gap-1',      // 작은 사이즈
  md: 'h-8 px-3 text-sm gap-1.5',    // 기본 사이즈
  lg: 'w-[104px] h-[48px] gap-[10px]',
};
